...
exports.CONFIG = {
    ...
    progressBar: new utils_1.CliProgress().getInstance(),
    whitelist: [
    ...
    MYX: {
        market: 'malaysia',
        home_page: 'https://www.bursamalaysia.com/market_information/equities_prices?legend[]=[S]&sort_by=short_name&sort_dir=asc',
        exchanges: ['MYX'],
