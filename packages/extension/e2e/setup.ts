...
export const shariahByExchange: [typeof exchanges[number], string, string][] =
  exchanges.map(findFirstStockByExchange(_shariahList)).filter(Boolean);
