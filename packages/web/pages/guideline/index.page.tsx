  ...
  return (
    <div class='prose'>
      ...
      <div class='rounded p-2 border-3 border-dotted bg-green-50 text-green-700 border-green-600'>
        ...
        <ul class='!m-0'>
          <li>
            Before buying you should spend your time learning and understanding <b>Zakat</b> types and its calculation.
            Avoiding Zakat will not smoothen your afterlife journey.
          </li>
          <li>
