...
const images = [
  [
    ...
    <div>
      <p>
        ...
        <a href="https://wahedinvest.com/get-started/">
          https://wahedinvest.com/get-started/
        </a>
      </p>
    </div>,
  ],
  ...
  [
    ...
    <div>
      <p>
        Create your own password and make sure it is compliance with these
        requirements
      </p>
    </div>,
  ],
  ...
  [
    ...
    <div>
      <p>
        This step contain a series of questionnaire which help you identify
        which kind of portfolio suites you the most.
      </p>
    </div>,
  ],
  [],
  [
    <div class="sticky pb-12 bg-gray-900 top-[20px] md:top-[90px] col-span-2">
      <p class="py-3 text-xl text-center !my-0">
  ...
  [
    ...
    <div>
      <p>
        <b class="text-green-500">8.26%</b> based on historical returns. You
        also can select different portfolio by clicking the right/left arrow
        above.
      </p>
    </div>,
  ],
  ...
  [
    ...
    <div>
      <p>
        Check the <b>I agree to the term and conditions</b> and click 'Next'
        button
      </p>
    </div>,
  ],
  ...
  [
    ...
    <div>
      <p>
        Once you added the referer code, it will state{" "}
        <b>Referral code added.</b> Afterwards, you can add funds by deposit or
        wire transfer with any amount to Wahed.
      </p>
    </div>,
  ],
].map(([i, text]) =>
  typeof i === "number" ? (
    <>
      ...
      />
      <div class="sticky px-5 pb-12 bg-gray-900 top-[20px] md:top-[90px] col-span-2 md:col-span-1 md:pb-0">
        {text}
      </div>
    </>
  ) : (
...
export default function Guideline(): JSX.Element {
  ...
  return (
    <div class="mx-auto bg-gray-900 prose">
      ...
      <div className="max-w-md mx-auto md:max-w-full grid grid-cols-2 gap-y-0 md:gap-y-2">
        {images}
      </div>
    </div>
  );
