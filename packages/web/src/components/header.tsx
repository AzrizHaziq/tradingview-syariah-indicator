...
export const Header = (): JSX.Element => {
  return (
    <header class='sticky top-0 z-10 text-gray-600 bg-gray-700 body-font'>
      <div class='container flex md:flex-row items-center p-5 mx-auto md:flex-row gap-2'>
        <a href='/' class='flex items-center font-medium text-gray-900 mb-0 title-font'>
        ...
        <nav class='flex flex-wrap gap-5 justify-center items-center w-full text-base md:py-1 md:mr-auto md:ml-4'>
          ...
          <NavLink
            class='ml-0 text-white hover:text-green-500 md:ml-auto'
            activeClass='text-green-300'
            href='/data-source'>
            DataSource
          </NavLink>
          <NavLink class='ml-0 text-white hover:text-green-500' activeClass='text-green-300' href='/wahed'>
            Wahed
          </NavLink>
        </nav>
      </div>
