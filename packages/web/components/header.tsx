...
export const Header = (): JSX.Element => {
  return (
    <header className='sticky top-0 z-10 text-gray-600 bg-gray-700 body-font'>
      <div className='container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row'>
        ...
        <nav className='flex flex-wrap items-center justify-center text-base md:mr-auto md:ml-4 md:py-1 md:pl-4 gap-5'>
