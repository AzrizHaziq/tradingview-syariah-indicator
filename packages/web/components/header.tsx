  ...
  return (
    <header class='sticky top-0 z-10 text-gray-600 bg-gray-700 body-font'>
      <div class='container flex flex-col items-center p-5 mx-auto md:flex-row'>
        ...
        <nav class='flex flex-wrap items-center justify-center w-full text-base md:mr-auto md:ml-4 md:py-1 gap-5'>
          ...
          <NavLink class='ml-0 text-white md:ml-auto hover:text-green-500' activeClass='text-green-300' href='/wahed'>
            Wahed
          </NavLink>
        </nav>
      </div>
